    ...
    <section class="pages section-padding">
        <div class="container">
            <div class="section-header" data-aos="fade-up">
                ...
                <p class="section-subtitle">Мы стремимся к прозрачности и качеству в предоставлении наших AI-решений и обучающих материалов.</p>
            </div>
            ...
            <div class="legal-content" data-aos="fade-up" data-aos-delay="200">
                ...
                <ul>
                    <li>
                        <strong>Несоответствие программы описанию:</strong> Если содержание предоставленной консультации или обучающего материала по разработке ботов существенно отличается от программы, заявленной на сайте <strong><?= $domainTitle ?></strong> на момент покупки.
                    </li>
                    <li>
                        <strong>Технические неисправности:</strong> При возникновении критических программных проблем на платформе <strong><?= $fullDomain ?></strong>, которые делают доступ к AI-инструментам или сессиям невозможным и не были устранены нашей командой в течение 48 часов.
                    </li>
                    <li>
                        <strong>«Период охлаждения»:</strong> Если вы решили отказаться от участия в программе в течение 14 календарных дней с момента оплаты, при условии, что вы еще не получили доступ к значительной части материалов (см. раздел «Исключения»).
                    </li>
                </ul>

                <h2>Процедура запроса</h2>
                <p>Чтобы инициировать возврат на платформе <strong><?= $domainTitle ?></strong>, пожалуйста, выполните следующие шаги:</p>
                <ol>
                    <li>Отправьте письмо на наш email: <a href="mailto:hello@<?= $fullDomain ?>" class="text-gradient" style="font-weight: 700;">hello@<?= $fullDomain ?></a>.</li>
                    <li>В теме письма укажите: «Запрос на возврат средств — <?= $domainTitle ?>».</li>
                    <li>Укажите ваше имя, email, использованный при регистрации, и название выбранного модуля по разработке ботов.</li>
                    <li>Опишите причину запроса со ссылкой на условия политики.</li>
                    <li>Наша служба поддержки рассмотрит заявку и предоставит ответ в течение 3-х рабочих дней.</li>
                </ol>
                ...
                <p>
                    ...
                    Средства возвращаются тем же способом, которым была совершена оплата. Обратите внимание, что фактический срок зачисления может зависеть от регламента работы вашего банка во <strong>Франции</strong> или стране вашего пребывания.
                </p>
                ...
                <ul>
                    ...
                    <li>Вы изучили или скачали более 50% материалов программы по созданию AI-ассистентов.</li>
                    <li>Причиной невозможности прохождения обучения являются технические неполадки на стороне пользователя (проблемы с интернет-каналом или локальным ПО).</li>
                    <li>Были нарушены условия Пользовательского соглашения <strong><?= $domainTitle ?></strong>.</li>
                </ul>

                <h2>Свяжитесь с нами</h2>
                <p>
                    По всем вопросам, связанным с возвратом средств или условиями доступа к AI-платформе, пожалуйста, обращайтесь в нашу службу поддержки:
                    <br><br>
                    <strong>Email:</strong> <a href="mailto:hello@<?= $fullDomain ?>">hello@<?= $fullDomain ?></a><br>
                    <strong>Телефон:</strong> <a href="tel:+33189480032">+33 1 89 48 00 32</a>
                </p>

                <div class="pages-footer" style="margin-top: 50px; padding-top: 30px; border-top: 1px solid rgba(0,0,0,0.05);">
                    <p style="font-size: 0.9rem; opacity: 0.7;">Актуальная версия: Февраль 2026. Регион: Франция.</p>
                </div>
            </div>
        </div>
    </section>
