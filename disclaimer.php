    ...
    <section class="pages section-padding">
        <div class="container">
            <div class="section-header" data-aos="fade-up">
                ...
                <p class="section-subtitle">Дисклеймер платформы <?= $domainTitle ?> касательно использования материалов и внедрения AI-технологий.</p>
            </div>

            <div class="legal-content" data-aos="fade-up" data-aos-delay="200">
                <p>
                    <strong>Общая информация:</strong> Все материалы, технические обзоры и сведения,
                    ...
                    рассматриваться как профессиональный юридический, финансовый или технический совет, 
                    публичная оферта или гарантия конкретного результата при внедрении программного обеспечения.
                </p>
                ...
                <p>
                    ...
                    информации о работе нейросетей и алгоритмов. Любые упоминания эффективности автоматизации, 
                    программ пассивного дохода через AI-инструменты или прошлых результатов внедрения ботов 
                    не гарантируют аналогичных показателей в будущем. 
                    Индивидуальные итоги вашей деятельности зависят от множества факторов, включая рыночные условия во 
                    <strong>Франции</strong> и ЕС, технические параметры вашего проекта и могут существенно отличаться от приведенных примеров.
                </p>
                ...
                <p>
                    ...
                    любые прямые или косвенные убытки, программные сбои или действия,
                    предпринятые вами на основе информации с этого ресурса. Вся
                    ответственность за использование предложенных методологий разработки ботов и возможные последствия
                    лежит исключительно на пользователе. Контент платформы <strong><?= $domainTitle ?></strong> собирается из
                    источников, которые считаются надежными и передовыми в сфере AI на момент публикации.
                </p>

                <p>
                    <strong>Предупреждение о технологических рисках:</strong> Любая деятельность, направленная на
                    цифровую трансформацию бизнеса или внедрение AI-ассистентов, сопряжена с
                    ...
                    независимым техническим специалистом.
                </p>
